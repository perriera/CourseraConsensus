 ...
 * 
 *        NOTE: Node is an interface and does not have a constructor. However,
 *        your CompliantNode.java class requires a 4 argument constructor as
 *        defined in Simulation.java
 * 
 */
...
public interface Node {
    ...
    /**
     * @brief {@code followees[i]} is true if and only if this node follows node
     *        {@code i}
     */
    void setFollowees(boolean[] followees);

    /**
     * @brief initialize proposal list of transactions
     */
